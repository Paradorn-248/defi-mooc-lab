...
describe('Liquidation question3', function () {
    // for (let i = 0; i < 10; i++) {
    it('test', async function () {
        ...
        const gasPrice = 0
        const debt_in_USDC = 8556
        const debt_USDC = ethers.utils.parseUnits(debt_in_USDC.toString(), 6)
        console.log('debt_USDC:', debt_in_USDC.toString())
